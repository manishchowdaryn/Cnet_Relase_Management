Feature: Create New Release
  ...
  Scenario Outline: Release_Management in Chrome
    ...
    Examples: 
      ...
      | ananda@matildacloud.com | Ananda123@Matilda | TestMarch15_I_Version1 | Release Description | New_Enironment_Version | NewWorkflow  | Maneesh   | BambooTask | Path     | 8080 | admin           | admin           | http://54.149.196.230 | matilda        | matilda        |       8050 | MAT-TEST      | MAT              | TEST           | Template_March15 | New_TargetEnvironment_March15 | Success           |
