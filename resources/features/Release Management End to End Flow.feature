Feature: Release Management Automation Scenarios
  ...
  Scenario Outline: Release_Management(Create New Release) in Chrome
    ...
    Examples: 
      ...
      | admin@matildacloud.com | matilda  | Feb08_Release_Version1 | Release Description | New_Enironment_Version | NewWFNAB     | Maneesh   | AnsibleTask | Path     | 8080 | admin           | admin           | Template_Feb07 | New_TargetEnvironment_Feb07 | InProgress        |
  ...
  Scenario Outline: Release_Management(Create Release using Existing Template) in Chrome
    ...
    Examples: 
      ...
      | Feb08_Release_Version2 | Release Description | New_Enironment_Version | NewWFNAB     | InProgress        |
