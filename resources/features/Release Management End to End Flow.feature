Feature: Release Management Automation Scenarios
  ...
  Scenario Outline: Release_Management(Create New Release) in Microsoft Edge
    ...
    Examples: 
      ...
      | admin@matildacloud.com | matilda  | Feb11_Release_Version9 | Release Description | New_Enironment_Version | NewWFNAB     | Maneesh   | AnsibleTask | Path     | 8080 | admin           | admin           | Template_Feb11 | New_TargetEnvironment_Feb11 | InProgress        |
  ...
  Scenario Outline: Release_Management(Create Release using Existing Template) in Microsoft Edge
    ...
    Examples: 
      ...
      | Feb11_Release_Version10 | Release Description | New_Enironment_Version | NewWFNAB     | InProgress        |
